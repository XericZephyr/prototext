...
_ADDRESSBOOK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='manager', full_name='tutorial.AddressBook.manager', index=0,
...
_ADDRESSBOOK.fields_by_name['manager'].message_type = _PERSON
